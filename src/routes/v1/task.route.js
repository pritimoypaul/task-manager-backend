 ...
 *   get:
 *     summary: Get a task
 *     description: Logged in tasks can fetch only their own task information. Only admins can fetch other tasks.
 *     tags: [Tasks]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in tasks can only update their own information. Only admins can update other tasks.
 *     tags: [Tasks]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in tasks can delete only themselves. Only admins can delete other tasks.
 *     tags: [Tasks]
 *     security:
 *       - bearerAuth: []
 *     parameters:
